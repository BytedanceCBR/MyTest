...
@implementation AWEActionSheetTableCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _revokeLabel.textColor = [UIColor tt_themedColorForKey:kColorText5];
...
- (void)layoutSubviews {
    ...
    self.contentLabel.frame = CGRectMake(32 + padding, 0, (width - 32 * 2) * 3 / 4, self.contentView.height);
    self.contentLabel.centerY = self.contentView.centerY;
    [self.contentLabel setFont:[UIFont systemFontOfSize:16.0]];
    ...
    [self.revokeLabel setFont:[UIFont systemFontOfSize:16.0]];
