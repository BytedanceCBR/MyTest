...
#import "HTSVideoPlayTextViewInternal.h"

@interface HTSVideoPlayGrowingTextView(private)
-(void)commonInitialiser;
-(void)resizeTextView:(NSInteger)newSizeH;
-(void)growDidStop;
@end

@implementation HTSVideoPlayGrowingTextView
...
#endif
{
    ...
    r.origin.x = 0;
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
    internalTextView = [[HTSVideoPlayTextViewInternal alloc] initWithFrame:r textContainer:textContainer];
#else
    internalTextView = [[HTSVideoPlayTextViewInternal alloc] initWithFrame:r];
#endif
...
-(void)resizeTextView:(NSInteger)newSizeH
{
    ...
    internalTextViewFrame.size.width = self.frame.size.width - contentInset.left - contentInset.right;
