...
#define FRUploadImageErrorDomain @"com.bytedance.ugcUploadImage"
...
const static int FRUploadImageErrorImageURLNULL = 81105;
...
+ (void)uploadPhotoURL:(NSString *)url withExtParameter:(NSDictionary *)extParameter finishBlock:(void (^)(NSError * resultError, NSString * webURI, uint64_t width, uint64_t height, NSString * format))finishBlock;
@end
