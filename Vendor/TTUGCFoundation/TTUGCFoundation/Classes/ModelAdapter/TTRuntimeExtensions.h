...
typedef enum {
     ...
     */
    tt_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    tt_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    tt_propertyMemoryManagementPolicyCopy
} tt_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #tt_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    tt_propertyMemoryManagementPolicy memoryManagementPolicy;
