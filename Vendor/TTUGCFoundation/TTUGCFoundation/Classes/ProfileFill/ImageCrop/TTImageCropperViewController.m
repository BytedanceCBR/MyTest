//
//  TTImageCropperViewController.m
//  Article
//
...
@interface TTImageCropperViewController ()
...
@implementation TTImageCropperViewController
...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = [UIColor colorWithHexString:@"959597"].CGColor;
    self.ratioView.layer.cornerRadius = [UIScreen mainScreen].bounds.size.width/2.0;
...
- (void)initControlBtn {
    ...
    UIView *controMask = [[UIView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 72, [UIScreen mainScreen].bounds.size.width, 72)];
    controMask.backgroundColor = [UIColor blackColor];
    controMask.alpha = 0.6;
    [self.view addSubview:controMask];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 72, 80, 72)];
    cancelBtn.titleLabel.textColor = [UIColor colorWithHexString:@"ffffff"];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 80, self.view.frame.size.height - 70, 80, 70)];
    confirmBtn.titleLabel.textColor = [UIColor colorWithHexString:@"ffffff"];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(TTImageCropperDelegate)]) {
...
- (void)overlayClipping
{
    ...
    // MARK: circlePath
    [path appendPath:[UIBezierPath bezierPathWithArcCenter:self.overlayView.center radius:self.overlayView.width/2.0 startAngle:0 endAngle:2*M_PI clockwise:NO]];
