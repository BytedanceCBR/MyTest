...
- (void)_commonInit
{
    ...
    CGFloat originalHeightHalf = self.bounds.size.height / 2;
...
- (TTDiggButton *)diggButton
{
    if (!_diggButton) {
        ...
        _diggButton.multiDiggButtonPosition = TTMultiDiggButtonPositionLeft;
        _diggButton.multiDiggButtonLocation = TTMultiDiggButtonLocationComment;
