//
//  TTThreadRateOperateContentItem.h
//  Article
//
...
extern NSString * const TTActivityContentItemTypeThreadRateOperate;

@interface TTThreadRateOperateContentItem : NSObject <TTActivityContentItemProtocol>
