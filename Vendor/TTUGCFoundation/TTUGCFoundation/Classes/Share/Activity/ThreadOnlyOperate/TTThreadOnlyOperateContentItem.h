//
//  TTThreadOnlyOperateContentItem.h
//  Article
//
...
extern NSString * const TTActivityContentItemTypeThreadOnlyOperate;

@interface TTThreadOnlyOperateContentItem : NSObject <TTActivityContentItemProtocol>
