...
+ (UIView *)tabBarSnapShotView
{
    ...
    if ([rootWin.rootViewController isKindOfClass:[UITabBarController class]]) {
        UITabBarController * rootTabController = (UITabBarController *)rootWin.rootViewController;
