...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _bgButton.backgroundColors = @[@"fff2ed",@"fff2ed"];
        ...
        [_rightActionButton setImage:[UIImage themedImageNamed:@"refresh_close"] forState:UIControlStateNormal];
        [_rightActionButton.titleLabel setFont:[UIFont systemFontOfSize:kNotifyLabelFontSize]];
        _notifyLabel.textColors = @[[UIColor colorWithHexString:@"#ff8151"],[UIColor colorWithHexString:@"#ff8151"]];
...
{
    [self showMessage:message actionButtonTitle:title delayHide:delayHide duration:duration bgButtonClickAction:bgButtonBlock actionButtonClickBlock:actionButtonBlock didHideBlock:hideBlock willHideBlock:nil];
}
      ...
      willHideBlock:(XPNotifyBarWillHideBlock)willHideBlock
{
    ...
    if (self.willBeginHideBlock) {
        self.willBeginHideBlock(0.2, ArticleListNotifyBarViewAnimationType_Expand);
    }
...
- (void)hideSelf
{
    ...
    if (self.willBeginHideBlock) {
        self.willBeginHideBlock(0.3, ArticleListNotifyBarViewAnimationType_ScrollUp);
    }
