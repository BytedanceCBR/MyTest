...
@class TTDetailWebviewGIFManager;

#import <AKWebViewBundlePlugin/SSJSBridgeWebView.h>
#import <AKWebViewBundlePlugin/SSJSBridgeWebViewDelegate.h>
...
- (void)webView:(nullable TTDetailWebviewContainer *)webViewContainer scrollViewDidEndDragging:(nullable UIScrollView *)scrollView willDecelerate:(BOOL)decelerate;
...
@property (nonatomic, assign) CGFloat footerScrollViewOffsetY;
...
//webView正文视频
@property (nonatomic, strong, nullable) TTVBasePlayVideo *movieView;
@property (nonatomic, strong, nullable) NSDictionary *movieViewInfo;

@property (nonatomic, strong, nullable) TTDetailWebviewGIFManager *gifManager;

//自动降级, 默认为NO
@property (nonatomic, assign) BOOL needAutoDemoted;

- (nullable id)initWithFrame:(CGRect)frame disableWKWebView:(BOOL)disableWKWebView hiddenWebView:(SSJSBridgeWebView * _Nullable)hiddenWebView webViewDelegate:(SSJSBridgeWebViewDelegate * _Nullable)jsBridgeDelegate;
