//
//  TTAccountKeyChainStore.m
//  TTAccountKeyChainStore
//
...
NSString * const TTAccountKeyChainStoreErrorDomain = @"com.kishikawakatsumi.TTAccountKeyChainstore";
static NSString *_defaultService;

@interface TTAccountKeyChainStore ()

@end

@implementation TTAccountKeyChainStore
...
+ (TTAccountKeyChainStore *)keyChainStore
{
    return [[self alloc] initWithService:nil accessGroup:nil];
}

+ (TTAccountKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (TTAccountKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
+ (TTAccountKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(TTAccountKeyChainStoreProtocolType)protocolType
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:TTAccountKeyChainStoreAuthenticationTypeDefault];
}

+ (TTAccountKeyChainStore *)keyChainStoreWithServer:(NSURL *)server protocolType:(TTAccountKeyChainStoreProtocolType)protocolType authenticationType:(TTAccountKeyChainStoreAuthenticationType)authenticationType
{
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = TTAccountKeyChainStoreItemClassGenericPassword;
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(TTAccountKeyChainStoreProtocolType)protocolType
{
    return [self initWithServer:server protocolType:protocolType authenticationType:TTAccountKeyChainStoreAuthenticationTypeDefault];
}

- (instancetype)initWithServer:(NSURL *)server protocolType:(TTAccountKeyChainStoreProtocolType)protocolType authenticationType:(TTAccountKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = TTAccountKeyChainStoreItemClassInternetPassword;
...
- (void)commonInit
{
    _accessibility = TTAccountKeyChainStoreAccessibilityAfterFirstUnlock;
}
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    TTAccountKeyChainStore *keychain = [TTAccountKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
- (NSArray TTACCOUNT_KEY_TYPE *)allKeys
{
...
+ (NSArray TTACCOUNT_KEY_TYPE *)allKeysWithItemClass:(TTAccountKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == TTAccountKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == TTAccountKeyChainStoreItemClassInternetPassword) {
...
+ (NSArray *)allItemsWithItemClass:(TTAccountKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == TTAccountKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
...
- (void)setAccessibility:(TTAccountKeyChainStoreAccessibility)accessibility authenticationPolicy:(TTAccountKeyChainStoreAuthenticationPolicy)authenticationPolicy
{
...
+ (void)requestSharedWebCredentialWithCompletion:(void (^)(NSArray TTACCOUNT_CREDENTIAL_TYPE *credentials, NSError *error))completion
{
    [self requestSharedWebCredentialForDomain:nil account:nil completion:completion];
}

+ (void)requestSharedWebCredentialForDomain:(NSString *)domain account:(NSString *)account completion:(void (^)(NSArray TTACCOUNT_CREDENTIAL_TYPE *credentials, NSError *error))completion
{
...
//            attributes[(__bridge __strong id)kSecAttrAccessControl] = (__bridge_transfer id)accessControl;
        ...
        if (floor(NSFoundationVersionNumber) <= floor(iOS_7_1_or_10_9_2) && _accessibility == TTAccountKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly) {
#if TARGET_OS_IOS
            NSLog(@"%@", @"Unavailable 'TTAccountKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly' attribute on iOS versions prior to 8.0.");
#else
            NSLog(@"%@", @"Unavailable 'TTAccountKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly' attribute on OS X versions prior to 10.10.");
#endif
        } else {
...
{
    switch (_itemClass) {
        case TTAccountKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case TTAccountKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case TTAccountKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case TTAccountKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case TTAccountKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case TTAccountKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case TTAccountKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case TTAccountKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case TTAccountKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case TTAccountKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case TTAccountKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case TTAccountKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case TTAccountKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case TTAccountKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case TTAccountKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case TTAccountKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case TTAccountKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case TTAccountKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case TTAccountKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case TTAccountKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case TTAccountKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case TTAccountKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case TTAccountKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case TTAccountKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case TTAccountKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case TTAccountKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case TTAccountKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case TTAccountKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case TTAccountKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case TTAccountKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case TTAccountKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case TTAccountKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case TTAccountKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case TTAccountKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case TTAccountKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case TTAccountKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case TTAccountKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case TTAccountKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case TTAccountKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case TTAccountKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case TTAccountKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case TTAccountKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case TTAccountKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case TTAccountKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case TTAccountKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case TTAccountKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:TTAccountKeyChainStoreErrorDomain code:TTAccountKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:TTAccountKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:TTAccountKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:TTAccountKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
