...
#define TTACCOUNT_KEY_TYPE <NSString *>
#define TTACCOUNT_CREDENTIAL_TYPE <NSDictionary <NSString *, NSString *>*>
#else
#define TTACCOUNT_KEY_TYPE
#define TTACCOUNT_CREDENTIAL_TYPE
#endif
...
extern NSString * const TTAccountKeyChainStoreErrorDomain;

typedef NS_ENUM(NSInteger, TTAccountKeyChainStoreErrorCode) {
    TTAccountKeyChainStoreErrorInvalidArguments = 1,
};

typedef NS_ENUM(NSInteger, TTAccountKeyChainStoreItemClass) {
    TTAccountKeyChainStoreItemClassGenericPassword = 1,
    TTAccountKeyChainStoreItemClassInternetPassword,
};

typedef NS_ENUM(NSInteger, TTAccountKeyChainStoreProtocolType) {
    TTAccountKeyChainStoreProtocolTypeFTP = 1,
    TTAccountKeyChainStoreProtocolTypeFTPAccount,
    TTAccountKeyChainStoreProtocolTypeHTTP,
    TTAccountKeyChainStoreProtocolTypeIRC,
    TTAccountKeyChainStoreProtocolTypeNNTP,
    TTAccountKeyChainStoreProtocolTypePOP3,
    TTAccountKeyChainStoreProtocolTypeSMTP,
    TTAccountKeyChainStoreProtocolTypeSOCKS,
    TTAccountKeyChainStoreProtocolTypeIMAP,
    TTAccountKeyChainStoreProtocolTypeLDAP,
    TTAccountKeyChainStoreProtocolTypeAppleTalk,
    TTAccountKeyChainStoreProtocolTypeAFP,
    TTAccountKeyChainStoreProtocolTypeTelnet,
    TTAccountKeyChainStoreProtocolTypeSSH,
    TTAccountKeyChainStoreProtocolTypeFTPS,
    TTAccountKeyChainStoreProtocolTypeHTTPS,
    TTAccountKeyChainStoreProtocolTypeHTTPProxy,
    TTAccountKeyChainStoreProtocolTypeHTTPSProxy,
    TTAccountKeyChainStoreProtocolTypeFTPProxy,
    TTAccountKeyChainStoreProtocolTypeSMB,
    TTAccountKeyChainStoreProtocolTypeRTSP,
    TTAccountKeyChainStoreProtocolTypeRTSPProxy,
    TTAccountKeyChainStoreProtocolTypeDAAP,
    TTAccountKeyChainStoreProtocolTypeEPPC,
    TTAccountKeyChainStoreProtocolTypeNNTPS,
    TTAccountKeyChainStoreProtocolTypeLDAPS,
    TTAccountKeyChainStoreProtocolTypeTelnetS,
    TTAccountKeyChainStoreProtocolTypeIRCS,
    TTAccountKeyChainStoreProtocolTypePOP3S,
};

typedef NS_ENUM(NSInteger, TTAccountKeyChainStoreAuthenticationType) {
    TTAccountKeyChainStoreAuthenticationTypeNTLM = 1,
    TTAccountKeyChainStoreAuthenticationTypeMSN,
    TTAccountKeyChainStoreAuthenticationTypeDPA,
    TTAccountKeyChainStoreAuthenticationTypeRPA,
    TTAccountKeyChainStoreAuthenticationTypeHTTPBasic,
    TTAccountKeyChainStoreAuthenticationTypeHTTPDigest,
    TTAccountKeyChainStoreAuthenticationTypeHTMLForm,
    TTAccountKeyChainStoreAuthenticationTypeDefault,
};

typedef NS_ENUM(NSInteger, TTAccountKeyChainStoreAccessibility) {
    TTAccountKeyChainStoreAccessibilityWhenUnlocked = 1,
    TTAccountKeyChainStoreAccessibilityAfterFirstUnlock,
    TTAccountKeyChainStoreAccessibilityAlways,
    TTAccountKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly
    __OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0),
    TTAccountKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly,
    TTAccountKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly,
    TTAccountKeyChainStoreAccessibilityAlwaysThisDeviceOnly,
}
__OSX_AVAILABLE_STARTING(__MAC_10_9, __IPHONE_4_0);

typedef NS_ENUM(NSInteger, TTAccountKeyChainStoreAuthenticationPolicy) {
    TTAccountKeyChainStoreAuthenticationPolicyUserPresence = kSecAccessControlUserPresence,
};

/**
 *  1. 如果service和accessGroup都为nil，则service取bundleID, accessGroup为nil
 *
 *  2. 如果service为nil和accessGroup存在，则service = accessGroup
 
 *  3. 如果service存在和accessGroup为nil，则service和accessGroup使用当前值
 *
 *  4. 如果service和accessGroup都存在，则service和accessGroup使用当前值
 */
@interface TTAccountKeyChainStore : NSObject

@property (nonatomic, readonly) TTAccountKeyChainStoreItemClass itemClass;

@property (nonatomic, readonly, nullable) NSString *service;
@property (nonatomic, readonly, nullable) NSString *accessGroup;

@property (nonatomic, readonly, nullable) NSURL *server;
@property (nonatomic, readonly) TTAccountKeyChainStoreProtocolType protocolType;
@property (nonatomic, readonly) TTAccountKeyChainStoreAuthenticationType authenticationType;

@property (nonatomic) TTAccountKeyChainStoreAccessibility accessibility;
@property (nonatomic, readonly) TTAccountKeyChainStoreAuthenticationPolicy authenticationPolicy
__OSX_AVAILABLE_STARTING(__MAC_10_10, __IPHONE_8_0);
...
@property (nonatomic, readonly, nullable) NSArray TTACCOUNT_KEY_TYPE *allKeys;
...
+ (TTAccountKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (TTAccountKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
+ (nullable NSArray TTACCOUNT_KEY_TYPE *)allKeysWithItemClass:(TTAccountKeyChainStoreItemClass)itemClass;
- (nullable NSArray TTACCOUNT_KEY_TYPE *)allKeys;

+ (nullable NSArray *)allItemsWithItemClass:(TTAccountKeyChainStoreItemClass)itemClass;
...
+ (void)requestSharedWebCredentialWithCompletion:(nullable void (^)(NSArray TTACCOUNT_CREDENTIAL_TYPE *credentials, NSError * __nullable error))completion;
+ (void)requestSharedWebCredentialForDomain:(nullable NSString *)domain account:(nullable NSString *)account completion:(nullable void (^)(NSArray TTACCOUNT_CREDENTIAL_TYPE *credentials, NSError * __nullable error))completion;
...
@interface TTAccountKeyChainStore (ErrorHandling)
...
@interface TTAccountKeyChainStore (ForwardCompatibility)
