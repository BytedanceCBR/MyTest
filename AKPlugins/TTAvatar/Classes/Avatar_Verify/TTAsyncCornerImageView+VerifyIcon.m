//
//  TTAsyncCornerImageView+VerifyIcon.m
//  Article
//
...
@implementation TTAsyncCornerImageView (VerifyIcon)
...
- (void)setupVerifyViewForLength:(CGFloat)avatarLength
    ...
    verifyIconOffset = UIOffsetMake(verifyIconOffset.horizontal + self.borderWidth, verifyIconOffset.vertical + self.borderWidth);
