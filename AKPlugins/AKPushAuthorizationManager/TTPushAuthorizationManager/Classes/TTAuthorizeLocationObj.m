...
//        }
    ...
    if (status == kCLAuthorizationStatusDenied) {
        ...
        NSString *message = canOpenSettings ? @"智能推荐当前城市资讯，去设置中允许爱看定位" : @"智能推荐当前城市资讯，请去 设置-隐私-定位服务 内开启爱看访问权限";
...
//        }
        ...
        NSString *message = canOpenSettings ? @"开启定位失败，请去设置项允许爱看获取您的位置" : @"开启定位失败，请去 设置-隐私-定位服务 内开启爱看访问权限";
        NSString *okBtnTitle = canOpenSettings ? @"去设置" : @"我知道了";
...
- (void)_showCustomAuthorizeHintViewWithCompletionHander:(void (^)(NSArray *))completionHandler authCompleteBlock:(TTAuthorizeLocationAuthCompleteBlock)authCompleteBlock
{
    ...
    _hintView = [self authorizeHintViewWithTitle:@"开启定位" message:@"允许爱看获取定位权限，智能推荐当前城市资讯" imageName:@"img_popup_locate" okButtonTitle:@"确定" okBlock:^{
