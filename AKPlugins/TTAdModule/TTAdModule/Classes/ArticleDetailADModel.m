...
- (instancetype)initWithDictionary:(NSDictionary *)data
{
    ...
    if (self) {
        ...
        self.groupId = [data tt_stringValueForKey:@"group_id"];
        self.isVideoAutoPlay = [data tt_intValueForKey:@"video_auto_play"];
        self.isVideoPlayInDetail = [data tt_intValueForKey:@"video_play_in_detail"];
...
- (void)trackRealTimeDownload
{
    ...
    [params setValue:self.ad_id forKey:@"value"];
    [params setValue:@"realtime_ad" forKey:@"tag"];
    [params setValue:self.log_extra forKey:@"log_extra"];
