//
//  TTVPlayerTrackerV3.m
//  Article
//
//  Created by panxiang on 2017/7/30.
//
//
...
@implementation TTVPlayerTrackerV3
- (instancetype)init
{
    self = [super init];
    if (self) {
...
- (void)sendEnterFullScreenTrack
{
    ...
    [dic setValue:[self ttv_fullscreenAction] forKey:@"action_type"];
    [dic setValue:[self ttv_enterFullscreenType] forKey:@"fullscreen_type"];
    [TTTrackerWrapper eventV3:@"enter_fullscreen" params:dic isDoubleSending:YES];
}
