...
BOOL ttvs_videoMidInsertADEnable(void) {
    return [ttvs_videoMidInsertADDict() tt_boolValueForKey:@"tt_video_midpatch_req_not_ad"];
}
...
{
    return [[[TTSettingsManager sharedManager] settingForKey:@"tt_three_top_bar" defaultValue:@NO freeze:YES] boolValue];
}
...
{
    return [[TTSettingsManager sharedManager] settingForKey:@"tt_video_doubleTapForDigg_enabled" defaultValue:@YES freeze:NO];
}
