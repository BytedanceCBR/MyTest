...
- (UILabel *)defaultTitleLable {
    if (!_defaultTitleLable) {
        ...
        self.defaultTitleHasShadow = YES;
    }
...
- (void)setDefaultTitleHasShadow:(BOOL)defaultTitleHasShadow {
    _defaultTitleHasShadow = defaultTitleHasShadow;
    if (defaultTitleHasShadow) {
        _defaultTitleLable.layer.shadowColor = [UIColor colorWithWhite:0.0 alpha:0.54f].CGColor;
        _defaultTitleLable.layer.shadowRadius = 2.f;
        _defaultTitleLable.layer.shadowOpacity = 1.f;
        _defaultTitleLable.layer.shadowOffset = CGSizeZero;
    }
    else {
        self.defaultTitleLable.layer.shadowOpacity = 0;
    }
}
