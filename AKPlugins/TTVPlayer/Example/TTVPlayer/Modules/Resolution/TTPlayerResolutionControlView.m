...
@property (nonatomic, strong) TTAlphaThemedButton *fullHDButton;
@property (nonatomic, strong) TTAlphaThemedButton *hdButton;
@property (nonatomic, strong) TTAlphaThemedButton *sdButton;

@property (nonatomic, strong) TTAlphaThemedButton *currentButton;
...
- (void)_setSupportedTypes:(NSArray <NSNumber *> *)supportedTypes {
    ...
    [supportedTypes enumerateObjectsWithOptions:NSEnumerationReverse usingBlock:^(NSNumber * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        TTAlphaThemedButton *button = [self buttonForType:type];
...
- (TTAlphaThemedButton *)fullHDButton {
    if (!_fullHDButton) {
...
- (TTAlphaThemedButton *)themedButtonWithType:(TTVideoEngineResolutionType)type {
...
- (TTAlphaThemedButton *)buttonForType:(TTVideoEngineResolutionType)type {
    TTAlphaThemedButton *button;
    switch (type) {
