...
{ 
    ...
    [self addCacheDictObj:[NSDate dateWithTimeIntervalSinceNow:timeoutInterval] key:real_key];
...
- (BOOL)quickCheckIsImageInfosModelExist:(SSImageInfosModel *)model
{
...
- (NSData *)dataForImageInfosModel:(SSImageInfosModel *)model
{
