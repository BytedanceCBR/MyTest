...
#import "FHMessageNotificationWDInviteCell.h"
...
NS_INLINE CGFloat kDislikeNewStyleTitleFontSize(){
    return [FHMessageNotificationCellHelper tt_newPadding:12.0f];
}
...
NS_INLINE CGFloat kWDRewardIconImageViewHeight(){
    return [FHMessageNotificationCellHelper tt_newPadding:20.0f];
}
...
NS_INLINE CGFloat kWDMonwyLabelFontSize(){
    return [FHMessageNotificationCellHelper tt_newFontSize:10.f];
}
...
@implementation FHMessageNotificationWDInviteCell

+ (Class)cellViewClass{
    return [FHMessageNotificationWDInviteCellView class];
}

@end

@interface FHMessageNotificationWDInviteCellView()
...
@implementation FHMessageNotificationWDInviteCellView
...
+ (CGFloat)heightForData:(TTMessageNotificationModel *)data cellWidth:(CGFloat)width{
    ...
    height += [self heightForBodyTextLabelWithData:data maxWidth:width - FHMNBodyTextLabelLeftPadding() - FHMNBodyTextLabelDefaultRightPadding()];
...
- (void)refreshUI{
    ...
    if(!isEmptyString(self.actionTextLabel.text)){
        ...
        self.actionTextLabel.width = MIN(self.actionTextLabel.width, self.width - FHMNRoleInfoViewLeftPadding() - FHMNRoleInfoViewDefaultRightPadding() - kActionTextLabelLeftPadding());
        CGFloat maxRoleInfoViewWidth = self.width - FHMNRoleInfoViewLeftPadding() - FHMNRoleInfoViewDefaultRightPadding() - kActionTextLabelLeftPadding() - self.actionTextLabel.width;
    ...
    if(!isEmptyString(self.messageModel.user.contactInfo)){
        ...
        [self layoutBodyTextLabelWithOrigin:CGPointMake(FHMNBodyTextLabelLeftPadding(), self.contactInfoLabel.bottom + FHMNBodyTextLabelTopPadding()) maxWidth:self.width - FHMNBodyTextLabelLeftPadding() - FHMNBodyTextLabelDefaultRightPadding()];
    }
    else{
        self.contactInfoLabel.hidden = YES;
        [self layoutBodyTextLabelWithOrigin:CGPointMake(FHMNBodyTextLabelLeftPadding(), self.roleInfoView.bottom + FHMNBodyTextLabelTopPadding()) maxWidth:self.width - FHMNBodyTextLabelLeftPadding() - FHMNBodyTextLabelDefaultRightPadding()];
    }
