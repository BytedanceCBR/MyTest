...
- (void)setToolbarType:(FHExploreDetailToolbarType)toolbarType {
    ...
    switch (toolbarType) {
        case FHExploreDetailToolbarTypeNormal:
            ...
            break;
        case FHExploreDetailToolbarTypeOnlyWriteButton:
            _writeButton.hidden = NO;
            _emojiButton.hidden = NO;
            ...
            _digButton.hidden = YES;
            break;
        case FHExploreDetailToolbarTypeExcludeCommentButtons:
            ...
            _digButton.hidden = YES;
            break;
        case  FHExploreDetailToolbarTypeExcludeCollectButton:
            _writeButton.hidden = NO;
            _emojiButton.hidden = NO;
            _commentButton.hidden = NO;
            _collectButton.hidden = YES;
        ...
        case FHExploreDetailToolbarTypeArticleComment: {
            ...
            break;
        case FHExploreDetailToolbarTypePhotoComment: {
            _writeButton.hidden = NO;
            _emojiButton.hidden = NO;
            _commentButton.hidden = NO;
            _collectButton.hidden = NO;
            ...
            break;
        case FHExploreDetailToolbarTypePhotoOnlyWriteButton: {
            _writeButton.hidden = NO;
            _emojiButton.hidden = NO;
            _commentButton.hidden = YES;
            _collectButton.hidden = YES;
        ...
        case FHExploreDetailToolbarTypeCommentDetail: {
            _writeButton.hidden = NO;
            _emojiButton.hidden = NO;
            _commentButton.hidden = YES;
            _collectButton.hidden = YES;
...
- (void)layoutSubviews {
    ...
    if (self.toolbarType == FHExploreDetailToolbarTypeNormal) {
    ...
    } else if (self.toolbarType == FHExploreDetailToolbarTypeOnlyWriteButton) {
        ...
        emojiFrame = CGRectMake(CGRectGetMaxX(writeFrame) - 22 - 6, CGRectGetMinY(writeFrame) + (writeButtonHeight - 22) / 2, 22, 22);
    } else if (self.toolbarType == FHExploreDetailToolbarTypeExcludeCommentButtons) {
        ...
        shareFrame = CGRectMake(width - 38 - rightInset, iconTopMargin, 24, 24);
        collectFrame = CGRectMake(CGRectGetMinX(shareFrame) - 46 - margin, iconTopMargin, 24, 24);
    } else if (self.toolbarType == FHExploreDetailToolbarTypePhotoOnlyWriteButton) {
        CGFloat sidePadding = [TTDeviceHelper isPadDevice] ? [TTUIResponderHelper paddingForViewWidth:width] : 15.0f;
        writeFrame = CGRectMake(sidePadding + leftInset, writeTopMargin, width - sidePadding * 2 - hInset, writeButtonHeight);
        emojiFrame = CGRectMake(CGRectGetMaxX(writeFrame) - 22 - 6, CGRectGetMinY(writeFrame) + (writeButtonHeight - 22) / 2, 22, 22);
    } else if (self.toolbarType == FHExploreDetailToolbarTypeCommentDetail) {
...
- (void)relayoutItems
{
    if (![TTDeviceHelper isPadDevice] || _toolbarType == FHExploreDetailToolbarTypeOnlyWriteButton) {
        return;
    }
    /*
    ...
    //视频详情页横屏分屏模式下特殊适配
    if (self.fromView == FHExploreDetailToolbarFromViewVideoDetail &&
