//
//  TTAccountMobileCaptchaAlertView.m
...
@interface TTAccountMobileCaptchaAlertView ()
...
@property(nonatomic, strong) TTAccountMobileCaptchaBlock dismissBlock;

@end

static const NSInteger kWrongCaptchaErrorCode = 1021;

@implementation TTAccountMobileCaptchaAlertView
...
- (void)setError:(NSError *)error {
    if (error.code == kWrongCaptchaErrorCode) {
...
- (void)resendCaptchaActionFired:(id)sender {
    __weak TTAccountMobileCaptchaAlertView *weakSelf = self;
