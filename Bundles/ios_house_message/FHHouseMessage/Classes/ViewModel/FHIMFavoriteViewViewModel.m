...
@interface FHIMFavoriteViewViewModel()<UITableViewDelegate,UITableViewDataSource>
...
@implementation FHIMFavoriteViewViewModel
...
//列表页刷新 埋点
- (void)trackRefresh {
    NSMutableDictionary *dict = [NSMutableDictionary dictionaryWithDictionary:[self categoryLogDict]];
...
-(void)jump2HouseDetailPage:(FHSingleImageInfoCellModel *)cellModel withRank:(NSInteger)rank {
    ...
    NSMutableDictionary *traceParam =  [NSMutableDictionary dictionaryWithDictionary:[self categoryLogDict]];
