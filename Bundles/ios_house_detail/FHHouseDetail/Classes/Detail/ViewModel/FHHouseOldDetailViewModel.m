...
- (void)registerCellClasses {
    ...
    [self.tableView registerClass:[FHDetailDetectiveCell class] forCellReuseIdentifier:NSStringFromClass([FHDetailDetectiveCell class])];
...
- (Class)cellClassForEntity:(id)model {
    ...
    // 幸福天眼
    if ([model isKindOfClass:[FHDetailDetectiveModel class]]) {
        return [FHDetailDetectiveCell class];
    }
