...
- (void)processDetailData:(FHDetailOldModel *)model{
    ...
    if(([self isShowSubscribe]) && !model.data.downPaymentInfo){
        ...
        __weak typeof(self) wSelf = self;
        __weak FHDetailHouseSubscribeCorrectingModel *weakSubscribeModel = subscribeModel;
...
- (BOOL)isShowSubscribe {
    ...
    BOOL oldHouseSubscribe =  [fhSettings btd_boolValueForKey:@"f_is_show_house_sub_entry"];
...
-(NSArray<FHImageModel> *)instantHouseImages
{
