//
//  FHOldDetailSchoolInfoItemView.m
//  FHHouseDetail
//
...
@interface FHOldDetailSchoolInfoItemView ()

@property(nonatomic, strong)FHOldDetailSchoolInfoItemModel *itemModel;
...
@implementation FHOldDetailSchoolInfoItemView
...
{
    UILabel *nameKey = [UILabel createLabel:@"学校资源:" textColor:@"" fontSize:14];
    [nameKey sizeToFit];
    nameKey.left = 0;
...
- (void)setupUI
{
    ...
    UILabel *schoolKey = [UILabel createLabel:schoolTypeName textColor:@"" fontSize:14];
...
//    foldBtn.frame = CGRectMake(SCREEN_WIDTH - 30 - 16-97, schoolKey.top, 16, 16);
    [foldBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self).offset(-16);
        make.centerY.equalTo(schoolKey);
...
@implementation FHOldDetailSchoolInfoItemModel
