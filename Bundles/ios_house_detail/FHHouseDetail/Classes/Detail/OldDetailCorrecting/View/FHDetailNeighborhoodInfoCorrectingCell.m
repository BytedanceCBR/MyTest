...
@property (nonatomic, strong)   FHDetailNeighborhoodConsultCorrectingView       *consultView;
...
- (void)setupUI {
    ...
    _schoolView.backgroundColor = [UIColor clearColor];

    __weak typeof(self)wself = self;
    _consultView = [[FHDetailNeighborhoodConsultCorrectingView alloc] init];
    _consultView.backgroundColor = [UIColor clearColor];
