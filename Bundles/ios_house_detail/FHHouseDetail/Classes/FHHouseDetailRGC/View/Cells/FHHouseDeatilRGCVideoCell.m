...
- (void)layoutViews {
    ...
    [self.contentContainer mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.contentView).offset(cellModel.isInRealtorEvaluationList?10:0);
        make.right.equalTo(self.contentView).offset(cellModel.isInRealtorEvaluationList?-15:0);
        make.bottom.equalTo(self.contentView).offset(cellModel.isInRealtorEvaluationList?-15:0);
    }];
