...
- (CGFloat)heightForCommentCellLeftPicViewRegionWithTop:(CGFloat)top
{
    ...
    NSAttributedString *titleAttributedStr = [TTLabelTextHelper attributedStringWithString:titleStr fontSize:kUFDongtaiTitleFontSize() lineHeight:kUFDongtaiTitleLineHeight() lineBreakMode:NSLineBreakByTruncatingTail];
