...
@implementation TTLiveStarCell

/** 获取CellView类名 */
+ (Class)cellViewClass {
    return [TTLiveStarCellView class];
}

@end

@implementation TTLiveStarCellView
/** 更新界面数据 */
...
//        self.avatarView1.top = 15;
//        self.avatarView1.left = 15;
//
//        self.introduceView.height = ([TTDeviceHelper isScreenWidthLarge320] ? 14 : 12);
//        self.introduceView.left = 15 + 36 + 10;
//        self.introduceView.bottom = self.avatarView1.bottom - ([TTDeviceHelper isScreenWidthLarge320] ? 0.5 : 2.5);
