...
@implementation TTLiveVideoCell

/** 获取CellView类名 */
+ (Class)cellViewClass {
    return [TTLiveVideoCellView class];
}

@end

@implementation TTLiveVideoCellView
/** 更新界面数据 */
...
- (void)refreshUI {
    ...
    if (orderedData && [orderedData live]) {
        ...
        self.playView.centerX = self.picView.width / 2;
        self.playView.centerY = self.picView.height / 2;
