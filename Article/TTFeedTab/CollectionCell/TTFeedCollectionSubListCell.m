...
@interface TTFeedCollectionSubListCell () <ArticleBaseListViewDelegate>
@property(nonatomic, strong) ExploreSubscribeListView *listView;
@property(nonatomic, strong) TTCategory *category;
@end

@implementation TTFeedCollectionSubListCell
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.listView = [[ExploreSubscribeListView alloc] initWithFrame:self.bounds topInset:topPadding bottomInset:bottomPadding];
...
- (void)listViewStartLoading:(UIView *)listView
{
...
- (void)listViewStopLoading:(UIView *)listView
{
