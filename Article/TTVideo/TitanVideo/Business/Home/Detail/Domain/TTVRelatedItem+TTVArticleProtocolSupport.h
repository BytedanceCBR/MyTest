//
//  TTVRelatedItem+TTVArticleProtocolSupport.h
//  Article
//
...
@class ArticleDetail;
@interface TTVRelatedItem (TTVArticleProtocolSupport) <TTVArticleProtocol>
...
@property (nonatomic, retain, readonly) ExploreOrderedADModel *adModel;
...
@property (nonatomic, strong, readonly) NSArray *commoditys;//nil;相关视频没有
