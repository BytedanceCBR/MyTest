...
var n = (Math.floor(t / 1e3) / 10).toFixed(1);
i = (n.indexOf(".0") > -1 || n >= 10 ? n.slice(0, -2) : n) + "万";
} else {
var n = (Math.floor(t / 1e7) / 10).toFixed(1);
...
var t = 6e4, a = 60 * t, i = new Date(), n = i.getTime(), r = new Date(i.getFullYear(), i.getMonth(), i.getDate()), o = new Date(+e);
...
var o = "";
for (var s in r) o += "object" == typeof r[s] ? "&" + s + "=" + JSON.stringify(r[s]) : "&" + s + "=" + encodeURIComponent(r[s]);
i += o;
} else i += "&" + n + "=" + r;
}
try {
...
function n(e, t) {
var i = e.getBoundingClientRect(), n = i.top, r = i.height || i.bottom - i.top, o = n;
return a && (o = n + r), t >= o;
}
if (e && "function" == typeof t) {
var r = 0, o = window.innerHeight;
n(e, o) ? t() : document.addEventListener("scroll", i, !1);
}
}
...
function sendUmengWhenTargetShown(e, t, a, i, n, r) {
e && (isElementInViewportY(e, n) ? r && 3 === r.version ? sendUmengEventV3(t, i, !!r.isDoubleSend) : send_umeng_event(t, a, i) : imprProcessQueue.push(arguments));
}
...
userId: a.user_id,
name: a.user_name,
link: r.h5_settings.is_liteapp ? "sslocal://profile?refer=all&uid=" + a.user_id + "&from_page=wenda_detail" : a.schema + "&group_id=" + t.ansid + "&from_page=detail_answer_wenda",
intro: a.user_intro,
...
try {
if ("string" == typeof r.author.medals) {
var l = r.author.medals;
l = l.substring(l.indexOf("[") + 1, l.indexOf("]")), l = l.split(","), r.author.medals = [], 
r.author.medals = l.map(function(e) {
...
r.author.intro = c.join("，");
}
void 0 != a.read_count && (r.read_count = a.read_count), r.use_9_layout = a.use_9_layout, 
r.show_origin = 0 == a.show_origin ? 0 : 1, a.show_tips && (r.show_tips = a.show_tips), 
r.forum_extra = t, a.category_name && (r.category_name = a.category_name), a.log_pb && (r.log_pb = a.log_pb), 
...
}, (r.h5_settings.is_liteapp || !t.media_user_id) && (r.author.link = "sslocal://profile?refer=all&uid=" + t.media_user_id + "&from_page=article_detail");
var i = {
auth_type: "",
auth_info: ""
};
...
common: function() {
var t = e.h5_extra;
if ("custom_style" in e && (r.customStyle = e.custom_style), "novel_data" in t) if ("object" == typeof t.novel_data) r.novel_data = t.novel_data; else if ("string" == typeof t.novel_data) try {
...
var e, t = Page.wenda_extra, a = t.show_post_answer_strategy || {}, i = t.wd_version || 0, n = Page.h5_settings.is_liteapp, r = "show_top" in a && !n, o = "show_default" in a && !n;
...
e = $(r ? '<div class="wt">' + t.title + '</div><div class="ft"><span class="see-all-answers" id="total-answer-count"></span><span class="hide-placeholder">&nbsp;</span></div><a class="big-answer-buttoon go-to-answer" data-type="big" href="' + urlAddQueryParams(a.show_top.schema, {
source: "answer_detail_top_write_answer"
}) + '">' + a.show_top.text + '</a><div class="big-answer-buttoon-gap"></div>' : o ? '<div class="wt">' + t.title + '</div><div class="ft"><a class="go-to-answer go-to-answer-small" data-type="small" href="' + urlAddQueryParams(a.show_default.schema, {
...
removeLatency: 500
}), r ? $(".go-to-answer").on("click", function(e) {
...
var i = "{{0,0},{0,0}}", n = document.querySelector(e);
if (n) {
...
if (!n) return [ e, t, a ];
try {
e = n.startContainer.textContent.substring(0, n.startOffset).substr(-20), t = n.toString(), 
a = n.endContainer.textContent.substring(n.endOffset).substring(0, 20);
} catch (r) {}
return n.detach(), n = null, [ e, t, a ];
}
...
function dealOptionalStockButton(e, t, a, i, n) {
e.stopPropagation(), send_umeng_event("stock", "article_add_stock", n);
...
if (a !== last_score) {
var i = t.attr("data-type"), n = parseInt(t.attr("data-index")), r = {
evaluate_id: JSON.stringify({
gid: group_id,
style: "face",
string_id: score_card_info_string,
...
n === t ? e.setAttribute("data-status", "selected") : e.setAttribute("data-status", "unselected");
...
document.getElementById("thx-press-emoji").className = i + "-press", document.getElementById("thx-word").innerHTML = "您对本文的评价是：" + letters[score_card_info_string][n], 
...
n = e.data || e, 1 === Page.h5_settings.score_card_style ? processScoreCardByStar(n) : (Page.h5_settings.score_card_style > 1 || Page.h5_settings.score_card_style < 6) && processScoreCardByEmoji(n);
}) : 1 === Page.h5_settings.score_card_style ? processScoreCardByStar(n) : (Page.h5_settings.score_card_style > 1 || Page.h5_settings.score_card_style < 6) && processScoreCardByEmoji(n);
}
}
...
var n = e.offset();
location.href = "ios" == window.CLIENT_VERSION ? "bytedance://full_image?index=" + t + "&url=" + a[t] + "&left=" + n.left + "&top=" + n.top + "&width=" + e.width() + "&height=" + e.height() : "bytedance://large_image?index=" + t + "&url=" + a[t] + "&left=" + n.left + "&top=" + n.top + "&width=" + e.width() + "&height=" + e.height();
...
function motorDealerContextRender(e, t, a, i, n) {
var r = $(e({
data: n
})), o = {
page_id: "page_detail",
...
r.data("series_id", n.series_id), r.data("series_name", n.series_name), r.on("focus", ".j-motor-form-user", function() {
...
}, o), !1), e.attr("disabled", "disabled").text("提交中..."), void $.ajax({
url: "https://i.snssdk.com/motor/dealer/m/v1/commit_inquiry_info/",
data: {
user_name: c,
phone: d,
city_name: a,
dealer_ids: n.dealer_ids.join(","),
car_id: n.car_id,
data_from: "motor_media",
...
dataType: "jsonp",
success: function(t) {
e.removeAttr("disabled").text("立即获取最低价"), t.data && "true" === t.data.result ? (r.find(".motor-form-edit").hide(), 
r.find(".motor-form-sheet").show(), r.find(".j-close-dealer-card").hide()) : ToutiaoJSBridge.call("toast", {
text: "提交失败，请稍后重试",
icon_type: "icon_error"
});
},
...
}, o), !1), r.find(".motor-form-edit").show(), r.find(".motor-form-sheet").hide();
}), r.find(".j-close-dealer-card").on("click", function(e) {
...
}, o), !1), void ToutiaoJSBridge.call("appInfo", {}, function(e) {
var t = e.device_id || 0;
$.ajax({
...
dataType: "jsonp",
success: function(e) {
"success" === e.message ? r.hide() : console.warn(e.message);
},
error: function(e, t) {
r.hide(), console.warn(e, t);
}
});
...
}), r.find(".j-motor-form-head").on("click", function(e) {
...
var a = "https://m.dcdapp.com/motor/m/car_series/index?series_id=" + n.series_id + "&zt=tt_card_article";
location.href = "sslocal://webview?url=" + encodeURIComponent(a) + "&title=" + n.series_name + (t ? "&use_wk=1" : "");
}), needCleanDoms.push(r), n.pos > t ? $("article > div p:nth-of-type(" + Math.ceil(t / 2) + ")").after(r) : $("article > div p:nth-of-type(" + n.pos + ")").after(r), 
sendUmengEventV3("web_show_event", $.extend({
obj_id: "detail_scard_n_consultation_render"
}, o), !1), sendUmengWhenTargetShown(r.get(0), "web_show_event", "", $.extend({
obj_id: "detail_scard_n_consultation"
}, o), !0, {
version: 3,
isDoubleSend: !1
...
var e = $(this), t = e.data("userId"), a = e.data("mediaId"), i = e.hasClass("following"), n = e.attr("data-concerntype") || "", r = Page.article.type, o = "" === n, s = Page.hasExtraSpace && o;
if (!e.hasClass("disabled")) if ($(".subscribe-button").addClass("disabled"), $("header").addClass("canmoving"), 
$(".boot-outer-container").css("display", "none"), "pgc" === r) doFollowMedia(t, a, i, n), 
...
} else "forum" === r && (doFollowUser(t, a, i, void 0, followSource.forum, "detail"), 
...
var t = $(this).attr("it-is-user-id"), a = "", i = "", n = "";
...
n = wenda_extra.ansid), window.location.href = "sslocal://profile?uid=" + t + ("wenda" === Page.article.type ? "&refer=wenda" : "") + "&group_id=" + n + "&from_page=" + a + "&profile_user_id=" + Page.author.userId + (i ? "&category_name=" + i : "");
}
}

function mediasugFollowAction() {
var e = $(this), t = null != e.attr("isfollowing"), a = e.closest(".ms-item").attr("it-is-user-id"), i = e.attr("reason"), n = followSource[Page.article.type + "_sug"], r = e.closest(".ms-item").data("index");
...
Page.author.mediaId && (o.media_id = Page.author.mediaId), sendUmengEventV3(t ? "rt_unfollow" : "rt_follow", o, !1);
}
...
if (Array.isArray(e)) for (var i = e.length, n = 0; i > n; n++) e[n].user_id == a && (e[n].is_following = !t);
}, function() {}));
});
}
...
function doFollowUser(e, t, a, i, n, r) {
...
if (!a.width && !a.height) {
var i = .75, n = 0, r = i, o = "", s = this.naturalWidth, l = this.naturalHeight;
s && l && (n = l / s, i >= n ? r = n : o = "height: 100%; width: auto;");
var c = t.clientWidth;
t.css("height", c * r + "px"), this.setAttribute("style", o), e.setAttribute("data-video-size", JSON.stringify({
normal: {
h: l,
w: s
}
...
var a = $(t), i = t.dataset, n = i.width, r = i.height, o = .75, s = 0, l = o, c = "";
...
var n = $('[it-is-user-id="' + e.id + '"]');
n.length > 0 && "status" in e && (n.find(".ms-subs").attr("isfollowing", e.status ? "" : null).attr("disabled", null), 
...
var n = e[a].name.toLowerCase(), r = e[a].getAttribute("content");
n && r && (t[n] = r);
}
return function(e) {
return t[e];
...
return function(e) {
var a = Date.now();
0 === o.length && a - l > s ? (i.src = n + e, l = a) : (o.push(n + e), t());
};
}(), WendaCacheUmeng = [];
...
_bindEvent: function() {
var t = this.settings.holder, a = "" == this.settings.exceptSelector ? this.settings.bindSelector : [ this.settings.bindSelector, this.settings.exceptSelector ].join(","), i = this.settings.exceptSelector, n = this.settings.pressedClass, r = parseInt(this.settings.triggerLatency), o = parseInt(this.settings.removeLatency);
...
$(this).is(i) || (clearTimeout(e.mytimer), $(this).removeClass(n), e.tar = null);
}), $(t).on("touchend touchcancel", a, function(t) {
if (!$(this).is(i) && e.tar === t.target) {
clearTimeout(e.mytimer), $(this).hasClass(n) || $(this).addClass(n);
var a = $(this);
setTimeout(function() {
a.removeClass(n);
}, o);
...
var n = e[a].src, r = n.indexOf("/v55/js/lib.js");
if (r > -1) {
t = n.substr(0, r);
break;
}
...
r.bottom <= (window.innerHeight || document.body.clientHeight) && (n = "in"), "in" === n && "out" === e && (console.info("weitoutiao_in"), 
...
var i = client.isIOS && parseFloat(client.osVersion) > 8;
if ("auto" === t) {
e.data_source_show = {
dongchedi: "懂车帝",
yiche: "易车"
...
var r = e.data;
r.series_list.map(function(e, t) {
var a = t + 1;
e.open_url = "sslocal://webview?url=" + encodeURIComponent(e.open_web_url + "&zt=tt_article_bottom_muti_series_" + a) + "&title=" + encodeURIComponent(e.series_name) + (i ? "&use_wk=1" : ""), 
e.dealer_open_url = "sslocal://webview?url=" + encodeURIComponent(e.dealer_web_url + "&zt=tt_article_bottom_muti_dealer_" + a) + (i ? "&use_wk=1" : "");
});
var n = $(cardTemplateFunctions[t]({
data: r
}));
...
var r = e.data;
"暂无报价" !== r.official_price_wenan && (r.show_official_price = parseFloat(r.official_price_wenan), 
r.show_official_price = r.show_official_price.toFixed(2), r.show_official_price_unit = "万起"), 
"暂无报价" !== r.agent_price_wenan && (r.show_agent_price = parseFloat(r.agent_price_wenan), 
r.show_agent_price = r.show_agent_price.toFixed(2), r.show_agent_price_unit = "万起"), 
r.open_url = "sslocal://webview?url=" + encodeURIComponent(r.open_web_url + "&zt=tt_article_bottom_complex_series") + "&title=" + encodeURIComponent(r.series_name) + (i ? "&use_wk=1" : ""), 
r.open_more_url = "sslocal://webview?url=" + encodeURIComponent(r.open_web_url + "&zt=tt_article_bottom_complex_more") + "&title=" + encodeURIComponent(r.series_name) + (i ? "&use_wk=1" : ""), 
r.dealer_open_url = "sslocal://webview?url=" + encodeURIComponent(r.dealer_web_url + "&zt=tt_article_bottom_complex_dealer") + (i ? "&use_wk=1" : ""), 
r.car_models_list.map(function(e, t) {
e.open_url = "sslocal://webview?url=" + encodeURIComponent(e.open_web_url + "&zt=tt_article_bottom_complex_car_" + (t + 1)) + (i ? "&use_wk=1" : "");
});
var n = $(cardTemplateFunctions[t]({
data: r
}));
...
if (n.on("click", ".button", function(t) {
t.stopPropagation(), send_umeng_event("detail", "click_card_button", a);
var i = $(this), n = i.attr("action");
"concern" === n ? dealNovelButton(t, e, i, a) : "addStock" == n && dealOptionalStockButton(t, i, e, c, a);
...
n.find(".auto-muti-item-inner").on("click", function() {
var e = this.dataset;
location.href = e.href, sendUmengEventV3("web_clk_event", $.extend({
obj_id: "auto_muti_series_click",
series_name: _[e.index].series_name,
series_id: _[e.index].series_id,
...
series_name: _[t.index].series_name,
series_id: _[t.index].series_id,
series_index: 1 * t.index + 1
}, u), !1);
}), n.find(".auto-inelastic-list").on("touchstart touchmove", function() {
sendBytedanceRequest("disable_swipe");
}).on("touchend touchcancel", function() {
sendBytedanceRequest("enable_swipe");
});
} else if ("auto_complex" === t) {
var p = e.data.car_models_list, u = {
page_id: "page_detail",
group_id: Page.statistics.group_id,
media_id: Page.author.mediaId,
media_name: Page.author.name,
...
n.find(".series-wrap").on("click", function() {
...
}), n.find(".more-link").on("click", function() {
location.href = this.dataset.href, sendUmengEventV3("web_clk_event", $.extend({
obj_id: "auto_complex_more_click"
}, u), !1);
}), n.find(".car-item").on("click", function() {
...
} else "stock" === t ? (n.find('[data-label="card_selected"]').on("click", function(e) {
...
needCleanDoms.push(n), "wenda" === Page.article.type ? (isShowWendaFooter = 0, $("footer").append(n)) : "pgc" == Page.article.type && Page.novel_data && Page.novel_data.show_new_keep_reading ? $("footer").append(n) : $("footer").prepend(n), 
...
function e(e) {
var t = $("header"), i = $(".subscribe-button"), n = $(".subscribe-button-bottom");
...
i.addClass("following").removeClass("disabled"), t.attr("fbs", "following"), n.addClass("following").removeClass("disabled")) : (i.removeClass("following disabled"), 
t.attr("fbs", ""), t.attr("sugstate", "no"), n.removeClass("following disabled"));
}
var t, a;
return function(i, n, r) {
"function" == typeof r && r(i), n ? i !== a && (clearTimeout(t), a = i, t = setTimeout(e, 450, i, r)) : e(i, r);
};
}(), followSource = {
pgc: 30,
pgc_sug: 34,
...
domPrepare(), i(t.data.recommend_users)) : n(t, r, o));
},
...
i = t.data || t, $.extend(!0, c, i), e(c, n, r);
}) : ($.extend(!0, c, i), e(c, n, r));
}
};
}(), mediasugScroll = function() {
var e, t, a, i = innerWidth, n = 150, r = 0, o = {}, s = 0, l = !1, c = [], d = "in", u = null, p = 0, m = $("header").height() + 232;
return {
init: function(d) {
...
var n = Object.keys(a);
mediasugScroll.dealimpr(n, t), c = e;
}
},
open: function() {
...
null === u && (u = e);
var t = e - u, a = Math.ceil(p / n) * n - p;
a = 0 === a ? n : a, $("#mediasug-list").scrollLeft(p + Math.min(t / 2, a)), 2 * n > t && requestAnimationFrame(mediasugScroll.horizontalScrollLeft);
},
next: function() {
...
var t, a, i, n, r, o, s = $("body").height();
if (r = e.rect.substring(1, e.rect.length - 1).split(","), t = r[0], a = Math.abs(r[1]), 
i = r[2], n = r[3], s === innerHeight) o = a >= m ? "out" : "in"; else {
var l = s - innerHeight;
o = a >= m - l ? "out" : "in";
}
...
var a = e.getAttribute("type") || "", i = +e.getAttribute("width") || 0, n = +e.getAttribute("height") || 0, r = +e.getAttribute("thumb_width") || 0, o = +e.getAttribute("thumb_height") || 0, s = {
index: t,
holder: e,
...
var n = document.createDocumentFragment(), r = this.adjustOriginImageScale(e.sizeArray[e.sizeType], e.state);
if ("" !== e.url) {
var o = document.createElement("img");
o.onload = function() {
console.info("onload", e, this), "function" == typeof i && i();
var t = this.naturalWidth, a = this.naturalHeight, n = e.sizeArray[e.sizeType];
(t || a) && (n[0] !== t || n[1] !== a) && (console.info(n[0], t, n[1], a), e.sizeArray[e.sizeType] = [ t, a ], 
IOSImageProcessor.renderHolder(e)), this.onload = null;
}, o.src = e.url, n.appendChild(o);
}
var s;
...
n.appendChild(s), s = null); else if (e.isLONG && IOSImageProcessor.isDuoTuThread) s = document.createElement("i"), 
s.setAttribute("class", "image-subscript long-subscript"), s.textContent = "长图", 
n.appendChild(s), s = null; else if (e.autoscript && "big" === e.sizeType) {
...
l.setAttribute("class", "image-subscript autoscript"), n.appendChild(l), l = null;
}
"origin" !== e.state && (s = document.createElement("i"), s.classList.add("spinner"), 
n.appendChild(s), s = null);
var c = e.holder;
if (t ? c.setAttribute("index", e.index) : c.innerHTML = "", c.appendChild(n), c.setAttribute("state", e.state), 
c.setAttribute("bg", r[0] > 140 && r[1] > 44), IOSImageProcessor.threadGGSwitch && 1 === IOSImageProcessor.allPicturesCount && (c.parentNode.style.paddingTop = 0, 
c.parentNode.style.height = r[1] + "px"), c.style.width = r[0] + "px", c.style.height = r[1] + "px", 
...
var r = "full_image?" + obj2search(IOSImageProcessor.currentViewing);
sendBytedanceRequest(r), console.info(r), "origin" !== a && ToutiaoJSBridge.call("loadDetailImage", {
type: (IOSImageProcessor.isDuoTuThread ? "thumb" : "origin") + "_image",
index: e
});
}
},
appendLocalImage: function(e, t, a, i, n) {
console.info("appendLocalImage", arguments);
var r = IOSImageProcessor.pictures[e];
if (r.url = t, r.state = a, r.sizeType = IOSImageProcessor.state2size[a], !t && "origin" === a && i && n ? (r.nativePlayGifLoaded = !0, 
r.sizeArray.big = [ i, n ], IOSImageProcessor.renderHolder(r)) : "boolean" == typeof i && "function" == typeof n ? IOSImageProcessor.renderHolder(r, !1, i, n) : IOSImageProcessor.renderHolder(r), 
...
var s = r.href, l = s.match(/url=([^&]*)/);
if (l) {
l = l[0];
var c = arguments[3], d = arguments[4];
"number" == typeof c && "number" == typeof d || IOSImageProcessor.pictures.forEach(function(i, n) {
!i.url && n !== e && i.href.indexOf(l) > -1 && (console.info("找到相同图片", e, n), IOSImageProcessor.appendLocalImage.call(IOSImageProcessor, n, t, a, c, d));
});
}
},
...
var i = t.holder, n = i.parentNode;
"P" === n.tagName ? "" !== n.textContent ? (console.info("[" + a + "]所在段落有文本，应当分割"), 
e(n, i, "span")) : n.querySelectorAll(".image").length > 1 ? (console.info("[" + a + "]所在段落有其他图片，应当分割"), 
e(n, i, "span")) : (console.info("[" + a + "]正确"), n.classList.add("image-wrap")) : (console.info("[" + a + "]直接加包裹"), 
e(n, i, "p"));
});
},
...
var r, o, s = e[0] / e[1];
return r = e[0] ? e[0] > n ? window.aW : e[0] : a, o = s ? parseInt(r / s) : i, 
"none" === t && (o = Math.min(o, .8 * window.iH)), [ r, o ];
},
bindEvents: function() {
