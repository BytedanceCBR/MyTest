...
class TabViewController: UITabBarController {
    ...
    let articleVC: UIViewController
    ...
    @objc init(withArticleVC: UIViewController) {
        self.articleVC = withArticleVC
    ...
    override func viewDidLoad() {
        ...
        articleVC.title = "发现"
        articleVC.tabBarItem.image = #imageLiteral(resourceName: "tab-message")
        articleVC.tabBarItem.selectedImage = #imageLiteral(resourceName: "tab-message-pressed")
        articleVC.tabBarItem.title = "发现"
