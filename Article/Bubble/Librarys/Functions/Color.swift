...
typealias ImageFilter = (UIImage) -> UIImage

let kFHDarkIndigoColor = "#081f33" // blue1
let kFHClearBlueColor = "#299cff" // blue2
let kFHMutedBlueColor = "#3d6e99" // blue3
let kFHVeryLightBlueColor = "#e6f3ff" // blue4

let kFHCharcoalGreyColor = "#45494d" // gray1
let kFHBattleShipGreyColor = "#737a80" // gray2
let kFHCoolGrey3Color = "#8a9299" // gray3
let kFHCoolGrey2Color = "#a1aab3" // gray4
...
func fillColorOnShap(color: UIColor) -> ImageFilter {
    return { (image) in
