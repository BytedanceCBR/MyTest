...
//        re.segmentEdgeInset = UIEdgeInsets(top: 0, left: 20, bottom: 0, right: 0)
    ...
    init() {
        ...
        EnvContext.shared.client.generalBizconfig.generalCacheSubject.skip(1).throttle(0.4, latest: false, scheduler: MainScheduler.instance).subscribe(onNext: { [weak self] data in
