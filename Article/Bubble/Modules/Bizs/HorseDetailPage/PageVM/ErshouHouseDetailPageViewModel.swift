        ...
        if let data = ershouHouseData.value?.data {
            ...
            */
            ...
            let dataParser = DetailDataParser.monoid()
                ...
                <- parseHeaderNode("小区 \(data.neighborhoodInfo?.name ?? "")", subTitle: "查看更多", showLoadMore: data.neighborhoodInfo != nil ? true : false, adjustBottomSpace: data.neighborhoodInfo?.evaluationInfo != nil ? 0 : -10, process: openBeighBor) {
