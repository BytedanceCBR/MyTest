...
- (void)p_showNetTrafficView:(TTVideoTrafficViewStatus)status {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if ([TTVPlayerFreeFlowTipStatusManager shouldShowFreeFlowSubscribeTip]) {
            ...
            [BDTrackerProtocol eventV3:@"continue_button_show" params:params];
            [BDTrackerProtocol eventV3:@"purchase_button_show" params:params];
            
            WeakSelf;
            self.freeFlowTipView.continuePlayBlock = ^{
                StrongSelf;
                [BDTrackerProtocol eventV3:@"continue_button_click" params:params];
            ...
            self.freeFlowTipView.subscribeBlock = ^{
                StrongSelf;
                [BDTrackerProtocol eventV3:@"purchase_button_click" params:params];
