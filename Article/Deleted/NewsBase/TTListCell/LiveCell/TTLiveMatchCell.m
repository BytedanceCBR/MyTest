...
@implementation TTLiveMatchCell

/** 获取CellView类名 */
+ (Class)cellViewClass {
    return [TTLiveMatchCellView class];
}

@end


//var TTLiveMatchCellContext = 0

@implementation TTLiveMatchCellView
...
- (void)refreshUI {
    ...
    if (orderedData && [orderedData live]) {
        ...
        self.titleView.width = containWidth;
        
        self.picView.frame = CGRectMake(kPaddingLeft(), self.titleView.bottom + 16, containWidth, ceil(containWidth / 16 * 9));
        
        self.avatarView1.centerY = self.picView.height / 2;
        self.avatarView2.centerY = self.picView.height / 2;
        self.avatarView1.centerX = containWidth * 3 / 16;
        self.avatarView2.centerX = containWidth - self.avatarView1.centerX;
        
        self.scoreView.top = self.avatarView1.top - 3;
        self.scoreView.centerX = containWidth / 2;
        
        self.subtitleView.bottom = self.avatarView1.top + self.avatarView1.width + 6;
        self.subtitleView.centerX = containWidth / 2;
