...
- (void)refreshUI
{
    ...
    if (SSSplashADTypeVideoFullscreen == _adModel.splashADType) {
        ...
        _wifiImageView.origin = CGPointMake((_adSplashImgView.frame.size.width) - (_skipButton.frame.size.width ) - 14 - _wifiImageView.image.size.width - 9, _skipButton.origin.y + (skipButtonBgBtnHeight - skipButtonBgViewHeight)/2);
