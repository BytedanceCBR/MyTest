//
//  TTAdVideoRelateLeftImageView.m
//  Article
//
...
@interface TTAdVideoRelateLeftImageView ()
...
@implementation TTAdVideoRelateLeftImageView
...
-(void)refreshUI
{
    ...
    self.imageView.frame = CGRectMake(kLeftPadding, kTopPadding, imageWidth, imageHeight);
    
    CGFloat titleWidth = [self titleWidthForCellWidth:(self.frame.size.width)];
    CGFloat titleHeight = [self titleHeightForArticle:self.viewModel.article cellWidth:(self.frame.size.width)];
    ...
    self.titleLabel.frame = CGRectMake(self.width - kRightPadding - titleWidth, titleTop, titleWidth , titleHeight);
