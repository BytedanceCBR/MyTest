...
//#endif
    ...
    if (![TTDeviceHelper isPadDevice]) {
        NSMutableString *widthStyle = [NSMutableString stringWithFormat:@"<style>html,body{ width:%ipx;  overflow: hidden} body{-webkit-transition: opacity %@s ease-out; transition: opacity %@s ease-out;}</style>", (int)(webView.frame.size.width), @(0.25), @(0.25)];
