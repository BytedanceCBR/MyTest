//
//  TTVRelatedVideoADPic+TTVDetailRelatedADInfoDataProtocol.h
//  Article
//
...
@interface TTVRelatedVideoADPic(TTVDetailRelatedADInfoDataProtocol) <TTVDetailRelatedADInfoDataProtocol>
