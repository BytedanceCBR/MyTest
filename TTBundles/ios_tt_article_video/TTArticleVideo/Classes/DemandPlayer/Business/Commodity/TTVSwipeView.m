...
@implementation NSObject (TTVSwipeView)

- (CGSize)swipeViewItemSize:(__unused TTVSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused TTVSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused TTVSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused TTVSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused TTVSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused TTVSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused TTVSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused TTVSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused TTVSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused TTVSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface TTVSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<TTVSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<TTVSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(TTVSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case TTVSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case TTVSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == TTVSwipeViewAlignmentCenter)
        {
