...
//            }
    ...
    if ([TTSandBoxHelper isInHouseApp] && [[NSUserDefaults standardUserDefaults]boolForKey:@"BOE_OPEN_KEY"]) {
        ...
        [[TTNetworkManager shareInstance] setBypassBoeJSON:@"{\"bypass_boe_host_list\": [\"mon.haoduofangs.com\", \"mon.snssdk.com\", \"soulkiller.bytedance.net\",\"p1.pstatp.com\",\"p3.pstatp.com\",\"p6.pstatp.com\",\"p9.pstatp.com\",\"p11.pstatp.com\"]}"];
    }
