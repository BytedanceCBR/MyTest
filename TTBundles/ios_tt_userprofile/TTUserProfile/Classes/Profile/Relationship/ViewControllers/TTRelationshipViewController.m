...
- (SSThemedView *)navigationView {
    if (!_navigationView) {
        _navigationView = [[SSThemedView alloc] initWithFrame:CGRectMake(0, 0, (self.view.frame.size.width), [SSNavigationBar navigationBarHeight])];
...
- (TTHorizontalCategoryBar *)navCategoryBar {
    if (!_navCategoryBar) {
        _navCategoryBar = [[TTHorizontalCategoryBar alloc] initWithFrame:CGRectMake(0, 20.f, (self.view.frame.size.width), 44.f) delegate:self];
