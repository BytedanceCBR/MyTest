...
- (void)refreshUI
{
    ...
    if ([self.orderedData isAdButtonUnderPic]) {
        self.adInfoBgView.frame = CGRectMake(kCellLeftPadding, self.picView.bottom - [TTDeviceHelper ssOnePixel], (self.picView.frame.size.width), kCellADInfoBgViewHeight);
