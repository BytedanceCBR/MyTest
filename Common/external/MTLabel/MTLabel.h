...
-(void)setLineHeight:(CGFloat)lineHeight;   // line height must be set after font set, not before
...
/*
 heightOfText method
 Only proper for following conditions:
 1. _minimumFontSize : 0.f
 2. _shouldResizeToFit : NO
 */
