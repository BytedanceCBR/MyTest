...
+ (NSAttributedString *)attributedStringWithMarkedString:(NSString *)markedText {
    return [self attributedStringWithMarkedString:markedText textAlignment:NSTextAlignmentLeft];
}
...
+ (NSAttributedString *)attributedStringWithMarkedString:(NSString *)markedText
    ...
    return [self attributedStringWithMarkedString:markedText paragraphStyle:paragraph];
}
...
+ (NSDictionary *)dictionaryWithMarkedString:(NSString *)markedString {
    ...
    [attributeArray enumerateObjectsUsingBlock:^(NSString *obj, NSUInteger idx, BOOL *stop) {
        ...
        if (range.location != NSNotFound) {
            NSString *key = [[obj substringToIndex:range.location] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
            NSString *value = [[obj substringFromIndex:range.location + 1] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
